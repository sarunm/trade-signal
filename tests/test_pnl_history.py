...
async def test_pnl_history_daily_groups_by_bkk_date(client, db_session):
    db_session.add_all([
        Trade(
            id=uuid4(), ticket=1001, symbol="GOLD#", direction=Direction.buy,
        ...
        Trade(
            id=uuid4(), ticket=1002, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
        ...
        Trade(
            id=uuid4(), ticket=1003, symbol="GOLD#", direction=Direction.sell,
            order_state=OrderState.filled, is_paper=False,
...
async def test_pnl_history_weekly_groups_by_iso_week(client, db_session):
    db_session.add_all([
        Trade(
            id=uuid4(), ticket=2001, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
        ...
        Trade(
            id=uuid4(), ticket=2002, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
        ...
        Trade(
            id=uuid4(), ticket=2003, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
...
async def test_pnl_history_monthly_groups_by_first_of_month(client, db_session):
    db_session.add_all([
        Trade(
            id=uuid4(), ticket=3001, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
        ...
        Trade(
            id=uuid4(), ticket=3002, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
...
async def test_pnl_history_all_returns_row_per_trade(client, db_session):
    db_session.add_all([
        Trade(
            id=uuid4(), ticket=4001, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
        ...
        Trade(
            id=uuid4(), ticket=4002, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
...
async def test_pnl_history_pagination_truncates_to_page_size(client, db_session):
    for i in range(5):
        db_session.add(Trade(
            id=uuid4(), ticket=5000 + i, symbol="GOLD#", direction=Direction.buy,
            order_state=OrderState.filled, is_paper=False,
...
async def test_pnl_history_out_of_range_page_returns_empty(client, db_session):
    db_session.add(Trade(
        id=uuid4(), ticket=6001, symbol="GOLD#", direction=Direction.buy,
        order_state=OrderState.filled, is_paper=False,
