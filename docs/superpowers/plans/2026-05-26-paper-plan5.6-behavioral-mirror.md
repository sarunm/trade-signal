...
- [ ] **Step 2: Run migration in Docker to verify upgrade succeeds**
...
- [ ] **Step 1: Add field to `PaperTraderRule`**
...
- [ ] **Step 3: Verify ORM imports cleanly**
...
- [ ] **Step 1: Write failing test for arming**
...
- [ ] **Step 3: Implement arm logic in `paper_exit_manager`**
...
- [ ] **Step 4: Run all paper_exit_manager tests to verify**
...
- [ ] **Step 1: Write failing tests for peak update + retrace close**
...
- [ ] **Step 2: Run tests to verify they pass (logic already implemented in Task 5)**
...
- [ ] **Step 1: Mark Plan 5.5 Task 3 (#66) as deleted via TaskUpdate**
...
- [ ] **Step 3: No commit needed** (task list is harness state, not in git).
